...
def starte_bot():
    ...
    print("starte_bot() aufgerufen.")  # Debugging
    global root, status_label, gate_keys_var, replay_keys_var, hunter_keys_var, chaos_keys_var, gate_vars, category_var, equipment_var, hunter_level_var, chaos_selection_var, head_photo, key_photos, gate_photos
    try:
        # UI-Setup
        root = tk.Tk() # root initialisieren
        ...
        try:
            ...
            print("starte_bot(): head.png nicht gefunden.")  # Debugging
        ...
        try:
            ...
            print("starte_bot(): key2.png nicht gefunden.")  # Debugging
        ...
        try:
            ...
            print("starte_bot(): key3.png nicht gefunden.")  # Debugging
        ...
        try:
            ...
            print("starte_bot(): key4.png nicht gefunden.")  # Debugging
        ...
        # Button zum Starten der Bot Funktion
        start_button = ttk.Button(main_frame, text="Start", command=lambda: root.after(0, starte_bot), style="TButton")  # starte_bot nach mainloop() starten
        ...
        print("starte_bot(): UI-Code ausgeführt.")  # Debugging
        root.mainloop()
        print("starte_bot(): UI-Schleife beendet.")  # Debugging
    except Exception as e:
        print(f"starte_bot() Fehler: {e}")

def aktualisiere_status(status):
    """Updates the status display in the UI."""
    print(f"aktualisiere_status(): Status: {status}")  # Debugging
